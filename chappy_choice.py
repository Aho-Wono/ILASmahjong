...
async def chappy_choice(situations , what_ai_can_do):
    load_dotenv(".env")
    KEY = "sk-proj-oOUMBCuEKRZyM2NFbrangb-MrJn" + "LnzR_GBujy-j6dtpHUoWdIgNC-JkQIzSopIW4eAisbr-D0CT3BlbkFJOEK9e5DiP-9NybuRIysQoFORqxfwkBgPH--QCrbqHwcBPdtzz4RXoKYXB9IiNBisV4Y-0uB_0A"
    chatgpt = openai.OpenAI(api_key = KEY)
